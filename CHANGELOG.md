...
- Rename double_array to coords in `TermsQueryField` and field_value_array to value in `GeoLocation` ([#358](https://github.com/opensearch-project/opensearch-protobufs/pull/358))
### Removed
